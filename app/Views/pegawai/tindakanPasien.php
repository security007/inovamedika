...
<p>Notes:</p>
    <ul>
        <li>Tindakan terhadap pasien akan otomatis ditambahkan apabila tipe diagnosa ada pada data master penanganan</li>
        <li>Jenis obat ada pada data master obat</li>
    </ul>
</div>
<hr>
